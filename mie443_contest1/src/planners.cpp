...
vector<float> motionPlanner::simpleWallFollowing(float yaw, float laser)
{
    cout << "Inprogress" << endl;
}

vector<float> motionPlanner::tutorialPlanner(float x, float y, float yaw, uint8_t *bumper)
{
    float angular = 0.0;
    float linear = 0.0;
